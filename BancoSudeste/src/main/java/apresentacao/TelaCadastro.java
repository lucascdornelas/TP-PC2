...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        catch (NaoExisteDadosException ex) 
        {
            ...
            /*
            int novoCliente = Integer.parseInt(this.conta.getNumeroDaContaDoNovoCliente()) - 1;
            this.conta.setNumeroDaContaDoNovoCliente(Integer.toString(novoCliente));
            
            int ultimoCliente = Integer.parseInt(this.conta.getNumeroDaContaDoUltimoCliente()) - 1;
            this.conta.setNumeroDaContaDoUltimoCliente(Integer.toString(ultimoCliente));*/
